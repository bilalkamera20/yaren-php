...
function normalize_for_category($name) {
    ...
    $search  = ['/\bT RK\b/u', '/\bT RKIYEM\b/u', '/\bBENG\b/u', '/\bBENGT\b/u', '/\bAK T\b/u', '/\bS NEMA\b/u', '/\bM N KA\b/u', '/\bOCUK\b/u', '/\bM Z K\b/u', '/\bS ZC\b/u', '/\bSZC\b/u', '/\bLKE\b/u', '/\bYE IL AM\b/u', '/\bYE IL[ ]?CAM\b/u', '/\bT[ÜU]RK\b/ui'];
...
function categorize_channel($name) {
    ...
    $rules = [
        ...
        'TR Haber' => '/\bHABER\b|\bNEWS\b|BLOOMBERG|\bCNN\b|EKOTURK|\bEKO ?T[UÜ]RK\b|\bEKOL\b|A ?PARA|APARA|PARANIN|HALK TV|TELE ?1|SOZCU|S ZC|\bSZC\b|BENGU ?T[UÜ]RK|BENGUTURK|TRT WORLD|\bDHA\b|LIDER HABER|FLASH HABER|MEDYA HABER|GLOBAL HABER|TRABZON HABER|BEIN SPORTS HABER|T[UÜ]RKHABER|HABERT[UÜ]RK|HABERT RK|\bARTI TV\b/i',
